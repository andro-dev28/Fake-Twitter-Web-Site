...
<div class="container">
    <br><br><br>
    <h1 class="text-center card-title">Login to twitter account</h1>
    <br><br><br>
    <div class="row justify-content-center">
        <div class="col-md-7 col-11 card">
            ...
            <div class="input-group">
                ...
                <input required id="email" type="email" class="form-control" placeholder="Enter valid email address">
            </div>
            <br>
            <div class="input-group">
                <div class="input-group-prepend">
                ...
                <input required id="password" type="password" class="form-control" placeholder="Enter your account password">
            </div>
            <br>
            <div class="row justify-content-center">
